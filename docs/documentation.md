...
**_Problematiche_** sembra più complesso del previsto il far riconoscere i file componente .vue a typescript, procederò cercando altri metodi, fra questo l’uso della vue-cli.
